...
```{r tables,eval=T,echo=F}
kable(Alldat,caption = "All data for Erie County and two tracts")
kable(Testing_results1,align = 'c',caption="Statistical tests for 18-24 year olds",
      row.names = F)
kable(Testing_results2,align = 'c',caption="Statistical tests for >25 year olds",
      row.names = F)
```